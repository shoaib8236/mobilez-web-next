...
import { emailRule, passwordRule, requiredRule, numberRule } from "@/utils/rules";
        ...
        <Row gutter={[16, 16]}>
          ...
          <Col span={12}>
            <div className="signup_form">
              <h2>Sign Up</h2>
              <p>
                <span className="welcome_text">Welcome back!</span> please signup to your <br /> account.
              </p>
              <div>
                <Form onFinish={onSubmit} layout="vertical">
                    <Row gutter={[8, 8]}>
                    <Col lg={12} md={12} sm={24}>
                  <Form.Item layout="vertical" className="styled_input" name="fname" rules={requiredRule} label="First Name">
                    <Input placeholder="First Name" />
                  </Form.Item>
                  </Col>
                  <Col lg={12} md={12} sm={24}>
                  <Form.Item layout="vertical" className="styled_input" name="lname" rules={requiredRule} label="Last Name">
                  ...
                  <Col lg={12} md={12} sm={24}>
                  <Form.Item className="styled_input" name="email" rules={emailRule} label="Email">
                  ...
                  <Col lg={12} md={12} sm={24}>
                  <Form.Item name="city" label="Select Account Type">
                    <Select placeholder="Select Account Type" className="styled_select">
