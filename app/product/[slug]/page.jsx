          ...
          <Row gutter={[14, 14]}>
            ...
            <Col lg={12} md={12} sm={24} xs={24}>
              <div className="detail_content">
                ...
                <hr />
                <p>
                  <span className="text_secondary">Posted By:</span> &nbsp;Muhammad Hasnain
                </p>
                <p>
                  <span className="text_secondary">Posted At:</span> &nbsp;27-Nov-2023
                </p>
                <h3 className="posted_heading">
                  Posted By : <span className="text_secondary blinking_text">Muhammad Hasnain</span>
                </h3>
                ...
                <p>
                  Lorem ipsum dolor, sit amet consectetur adipisicing elit. Omnis rerum, doloribus neque natus quasi error possimus dolorem. neque natus quasi error possimus
                  dolorem.
                </p>
