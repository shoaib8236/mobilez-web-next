...
const Page = ({ params: { slug } }) => {
  ...
  console.log(productDetails , "details data")

  const productImages = productDetails?.productimages.map((item) => ({original:getImage(item?.img), thumbnail:getImage(item?.img)}))
            ...
            <Col lg={12} md={12} sm={24} xs={24}>
              <div className="detail_content">
                ...
                <div className="specs">
                  ...
                  <div>
                    <span>Product Condition:</span> {productDetails?.product_type}
                  </div>
                </div>
